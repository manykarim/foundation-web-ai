<template>
  <div class="block">
    <svg id="svg2" :width="width" :height="height" xmlns="http://www.w3.org/2000/svg" viewBox="40 40 122.4325 122.34125"
      version="1.1">
      <defs id="defs6">
      ...
      <g id="g10" transform="matrix(1.25,0,0,-1.25,0,202.34125)">
        <g id="g12">
          <g id="g14" clip-path="url(#clipPath16)">
            <g id="g20" transform="translate(52.4477,88.1268)">
              <path id="path22" :style="`fill:${color};fill-opacity:1;fill-rule:nonzero;stroke:none`"
